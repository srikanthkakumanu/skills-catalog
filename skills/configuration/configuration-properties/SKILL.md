...
The examples use Java 27 (this catalog's house baseline; see `conventions/java-baseline.md`) and Jakarta APIs supported by this Boot version. Keep dependencies managed by the project's Boot BOM.
