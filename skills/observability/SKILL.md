...
name: observability
description: >
  Observability reference for Spring Boot 4: service-wide Actuator/Micrometer/OTLP telemetry, plus Spring AI-specific model observability. Covers 2 topic(s): production-observability, ai-observability.
...
| Topic | Use when |
|---|---|
| [`production-observability/`](production-observability/SKILL.md) | Actuator, Micrometer Observation & Tracing, OpenTelemetry/OTLP export, structured logging, health probes, dashboards, alerts. |
| [`ai-observability/`](ai-observability/SKILL.md) | Spring AI model observations, token usage, latency, cost attribution, prompt/completion logging. |
...
- Anything outside the 2 topic(s) listed above — this skill covers only Spring Boot 4.x / Java 27 observability concerns.
