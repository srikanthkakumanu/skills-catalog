...
| **Isolated Skills** — Optional, standalone utilities that support the pipeline | | | | | |
| **Stack-Specific Extension** — Runs after `PRD.md`, conditional on `tech-stack`'s selection (Spring Boot 4.x / Java 27, Python 3.11.x AI-agentic, or evidence-gated Next.js/React/TypeScript frontend contexts) | | | | | |
| [`implementation-guide`](file:///Users/skakumanu/practice/skills-catalog/skills/implementation-guide/) | `1.0.0` | Resolves confirmed `tech-stack.md` playbook citations against this catalog's migrated Spring Boot 4.x / Java 27 reference guides and produces project conventions (`CLAUDE.md`/`AGENTS.md`). Makes no architecture, stack, or requirement decisions — not part of the six-phase decision pipeline below, and not read by any phase in it. | Antigravity, Claude, Codex | Lightweight Lookup + Resolution | [**`skills/implementation-guide/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/implementation-guide/README.md) |
| [`arch-diagram-generator`](file:///Users/skakumanu/practice/skills-catalog/skills/arch-diagram-generator/) | `1.0.0` | Transforms natural language system descriptions into polished, presentation-ready architecture diagrams suitable for solution design, technical presentations, and executive reviews. Supports layered architecture, agentic AI systems, business workflows, and enterprise-grade visual styling. | Antigravity, Claude, Codex | Lightweight Single-Pass + Visual Generation | [**`skills/arch-diagram-generator/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/arch-diagram-generator/README.md) |
| **Spring Boot 4.x Reference Skills** — Directly triggerable Spring Boot 4.x / Java 27 topic collections; also resolved by `implementation-guide` once `tech-stack` confirms a matching context | | | | | |
| [`rest-api`](file:///Users/skakumanu/practice/skills-catalog/skills/rest-api/) | `1.0.0` | REST controller conventions, API versioning, HATEOAS, OpenAPI-first generation, RFC 9457 error responses, and declarative HTTP interface clients (6 topics). | Antigravity, Claude, Codex | Lightweight Reference Lookup | [**`skills/rest-api/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/rest-api/README.md) |
| [`persistence`](file:///Users/skakumanu/practice/skills-catalog/skills/persistence/) | `1.0.0` | Spring Data JPA/Hibernate 7 entities, Spring Data Redis caching, Flyway migrations, transactional patterns, and JSpecify null-safety (5 topics). | Antigravity, Claude, Codex | Lightweight Reference Lookup | [**`skills/persistence/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/persistence/README.md) |
| [`security`](file:///Users/skakumanu/practice/skills-catalog/skills/security/) | `1.0.0` | First-party JWT authentication and OAuth2 resource-server validation with Spring Security 7 (2 topics). | Antigravity, Claude, Codex | Lightweight Reference Lookup | [**`skills/security/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/security/README.md) |
| [`architecture-patterns`](file:///Users/skakumanu/practice/skills-catalog/skills/architecture-patterns/) | `1.0.0` | Domain-driven design, hexagonal architecture, layered architecture, multi-tenancy, and Spring Modulith (5 topics). | Antigravity, Claude, Codex | Lightweight Reference Lookup | [**`skills/architecture-patterns/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/architecture-patterns/README.md) |
| [`messaging`](file:///Users/skakumanu/practice/skills-catalog/skills/messaging/) | `1.0.0` | Kafka/RabbitMQ/Pulsar/JMS event-driven messaging and Spring Cloud Gateway 5 edge routing (2 topics). | Antigravity, Claude, Codex | Lightweight Reference Lookup | [**`skills/messaging/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/messaging/README.md) |
| [`testing`](file:///Users/skakumanu/practice/skills-catalog/skills/testing/) | `1.0.0` | Unit, slice, and integration test structure and tooling — Mockito, `@WebMvcTest`, `@DataJpaTest`, Testcontainers (1 topic). | Antigravity, Claude, Codex | Lightweight Reference Lookup | [**`skills/testing/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/testing/README.md) |
| [`observability`](file:///Users/skakumanu/practice/skills-catalog/skills/observability/) | `1.0.0` | Actuator/Micrometer/OpenTelemetry production observability and Spring AI-specific model observability (2 topics). | Antigravity, Claude, Codex | Lightweight Reference Lookup | [**`skills/observability/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/observability/README.md) |
| [`batch`](file:///Users/skakumanu/practice/skills-catalog/skills/batch/) | `1.0.0` | Spring Batch 6 chunk-oriented jobs, restartability, and fault-tolerant ETL pipelines (1 topic). | Antigravity, Claude, Codex | Lightweight Reference Lookup | [**`skills/batch/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/batch/README.md) |
| [`ai-integration`](file:///Users/skakumanu/practice/skills-catalog/skills/ai-integration/) | `1.0.0` | Spring AI 2.0 ChatClient/RAG/embeddings integration and exposing app capabilities as MCP tools (2 topics). | Antigravity, Claude, Codex | Lightweight Reference Lookup | [**`skills/ai-integration/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/ai-integration/README.md) |
| [`resilience`](file:///Users/skakumanu/practice/skills-catalog/skills/resilience/) | `1.0.0` | Native `@Retryable`/`@ConcurrencyLimit` resilience and database-backed idempotency patterns (2 topics). | Antigravity, Claude, Codex | Lightweight Reference Lookup | [**`skills/resilience/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/resilience/README.md) |
| [`configuration`](file:///Users/skakumanu/practice/skills-catalog/skills/configuration/) | `1.0.0` | Grouped, typed `@ConfigurationProperties` binding, validation, profiles, and secrets (1 topic). | Antigravity, Claude, Codex | Lightweight Reference Lookup | [**`skills/configuration/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/configuration/README.md) |
| [`deployment`](file:///Users/skakumanu/practice/skills-catalog/skills/deployment/) | `1.0.0` | Container-native deployment: OCI images, buildpacks, AOT, and GraalVM native executables (1 topic). | Antigravity, Claude, Codex | Lightweight Reference Lookup | [**`skills/deployment/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/deployment/README.md) |
| [`reactive`](file:///Users/skakumanu/practice/skills-catalog/skills/reactive/) | `1.0.0` | Fully-reactive request paths: WebFlux, Reactor, R2DBC, streaming, and backpressure (1 topic). | Antigravity, Claude, Codex | Lightweight Reference Lookup | [**`skills/reactive/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/reactive/README.md) |
| **Frontend Reference Skills** — Directly triggerable Next.js/React/TypeScript topic collection; also resolved by `implementation-guide` once `tech-stack` confirms an evidence-gated frontend context | | | | | |
| [`frontend`](file:///Users/skakumanu/practice/skills-catalog/skills/frontend/) | `1.0.0` | Next.js 16 App Router, React 19 component patterns, TanStack Query data fetching, React Hook Form + Zod validation, Tailwind CSS styling, Vitest/RTL/Playwright testing, and performance/accessibility (8 topics). | Antigravity, Claude, Codex | Lightweight Reference Lookup | [**`skills/frontend/README.md`**](file:///Users/skakumanu/practice/skills-catalog/skills/frontend/README.md) |
...
```bash
# Install all skills to all supported runtimes (symlinks)
./install.sh
